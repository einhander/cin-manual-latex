...
\begin{landscape}   
    \begin{table}[htpb]
        \centering
        \caption{\textbf{ShuttlePROv2 key default arrangement for Cinelerra / Composer / Viewer}}
...
\begin{landscape}   
    \begin{table}[htpb]
        \centering
    \caption{\textbf{ShuttleXpress key default arrangement for Cinelerra / Composer / Viewer}}
    \label{tab:xpress}
    \begin{tabular}{c c c c c c c}       
        \toprule        
        K5 & K6 & K7 & K8 & K9 & & \\
