...
redistribute, and modify (except for "invariant sections") a work
...
accompanies GNU software.%   Refer to:
% {\small\url{https://en.wikipedia.org/wiki/GNU_Free_Documentation_License}}
...
Presented briefly here is an overview of \CGG{} Infinity and information provided in this manual.
The GG version of \CGG{} has been improved for \emph{stability}, \emph{modernized} to accommodate the
