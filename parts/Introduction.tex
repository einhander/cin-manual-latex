...
\begin{description}
    ...
    \item[Chapter \ref{cha:capturing_recording_media}] \nameref{cha:capturing_recording_media}.
        ...
        This chapter is helpful in learning how to capture and record media from various sources.  A section on using Cinelerra with broadcast TV is especially useful.
